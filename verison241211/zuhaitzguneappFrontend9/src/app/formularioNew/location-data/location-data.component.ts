...
export class LocationDataComponent implements OnChanges  {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes['formGroup']) {
      if (this.formGroup) {
        ...
        console.log('Ruta de la foto:', this.nombre_archivo);
      } else {
      ...
      reader.onload = (e) => {
        ...
        canvas.toBlob((blob) => {
          ...
          if (blob) {
            ...
            console.log("entro", this.selectedFile);
            // Generar una vista previa
            const previewReader = new FileReader();
            previewReader.onload = () => {
              this.photoPreview = previewReader.result as string;
              console.log("entro1", this.selectedFile);
              console.log("entro1", this.showPreview);
  ...
  togglePreview(archivo:any) {
      ...
      console.log("hollllllla",this.showPreview);
      const previewReader = new FileReader();
              previewReader.onload = () => {
                this.photoPreview = previewReader.result as string;
                console.log("entro1", archivo);
                console.log("entro1", this.showPreview);
  ...
  hidePreview() {
    ...
    console.log("hola", this.showPreview);
    this.cdr.detectChanges();
  }
  }
