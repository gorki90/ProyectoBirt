...
@Component({
  ...
  standalone: true,
  imports: [HttpClientModule, DasometricDataComponent, LocationDataComponent, HealthStatusComponent, TasksComponent, ReactiveFormsModule, CommonModule, Datos_menuComponent, Datos_menufooterComponent],
