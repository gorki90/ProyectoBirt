...
} from "./chunk-K5WHXBMC.js";
import "./chunk-ARDIML6Z.js";
import {
  ATTRIBUTION,
  OSM_default,
  XYZ_default
} from "./chunk-OZRGLRG3.js";
import {
  DECIMALS,
...
import "./chunk-MC76GXNE.js";
import "./chunk-VHHBHZNF.js";
import "./chunk-5CG4WCZK.js";
import {
  TileState_default
} from "./chunk-PWOXHWUC.js";
import "./chunk-UYGHXI4B.js";
import {
  scale as scale2,
  toSize
...
var DataTileSource = class extends Tile_default3 {
  ...
  getReprojTile_(z, x, y, targetProj, sourceProj) {
    const tileGrid = this.getTileGrid();
    const reprojTilePixelRatio = Math.max.apply(null, tileGrid.getResolutions().map((r, z2) => {
...
addDecoder([void 0, 1], () => import("./raw-C5A7X26H.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-QMNBIQIJ.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-6WCFOSY6.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-XBAUJNDT.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-652PIHHN.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-TNVWJP33.js").then((m) => __async(void 0, null, function* () {
  yield m.zstd.init();
  return m;
})).then((m) => m.default));
addDecoder(50001, () => import("./webimage-6J5O22II.js").then((m) => m.default));
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-525RFI3M.js").then((module) => {
