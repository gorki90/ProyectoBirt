...
// export class MostrarAtributosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.attributeService.atributos
          ...
          this.wfsService.getFeaturesId(this._id)
            ...
            .subscribe({
              next: (response: {}) => {
                ...
                this.attributes = response as Arbol;
                ...
                if (this.attributes.foto) {
                  ...
                  this.imageUrl='assets/img/Zuhaitzguneapp.png'; // Imagen predeterminada si no hay foto
                }
              },
      ...
      // Inicializa el estado de detalles a falso para cada tarea
      this.showDetails = this.attributesTask.tasks.map(() => false);
  }
