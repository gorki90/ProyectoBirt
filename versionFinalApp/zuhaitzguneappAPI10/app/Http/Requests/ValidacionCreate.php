...
class ValidacionCreate extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'locationData.codigo'=> ['required', 'unique:identificacion_localizacion,codigo', 'string', 'max:10','regex:/^[A-Za-z0-9]+$/'],
            ...
            'tasks.*.fecha_limite' => ['nullable', 'date','after:today', new FechaLimite],
        ];
    }
        /**
